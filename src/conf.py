...
class Config:
    ...
    def __post_init__(self):
        ...
        signals_values = {
            ...
            "macd_diff": {
                "signal_name": "macd_diff",
                "params": {"window_slow": 60, "window_fast": 20, "window_sign": 9},
            },
        ...
        for key, value in signals_values.items():
            signals_computed[key] = compute_signal(
                value["signal_name"], self.historical_data, **value["params"]
            )
